...
## Project Structure
    ...
    ├── testapiautocatalog_122606  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_122606`
...
2. Clone this repo and `cd testapiautocatalog_122606`
